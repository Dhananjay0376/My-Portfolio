...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      {/* Hero Section */}
      <section className="min-h-[120vh] w-full relative flex items-center justify-center overflow-hidden">
        <HeroCanvas />
        <FloatingBadge />
        
        <div className="z-10 flex flex-col items-center gap-24 mt-32 px-4">
          <TypingHeadline />
        ...
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 animate-bounce text-muted-foreground/20">
      ...
      {/* About Section */}
      <section id="about" className="min-h-screen w-full py-60 relative z-10 bg-background overflow-hidden bg-mesh">
